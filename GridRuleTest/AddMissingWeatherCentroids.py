...
open('CENTNewMissingPrismFile'+str(len(MissingFile))+'.txt','w').write(''.join(MissingFile))
open('CENTAbsentWeatherFiles'+str(len(MissingWFname))+'.txt','w').write(''.join(MissingWFname))
